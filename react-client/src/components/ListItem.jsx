    ...
    return(
      <div className="item">
        <li >
          ...
          <div style={this.props.goal.counter >= this.props.goal.frequency ? completedStyle : incompleteStyle} className="goalDescription">{ this.props.goal.initiate ? 'start' : 'quit' } { this.props.goal.description } ( { this.props.goal.counter } of { this.props.goal.frequency } )</div>&nbsp;
          <div className="icons">
